...
@section('content')
    <section id="home-section" class="hero">
        <div class="home-slider owl-carousel">
            @foreach ($sliderData as $key => $item)
                <div class="slider-item" style="background-image: url({{ asset($item->slider_img) }});">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                            <div class="col-md-12 ftco-animate text-center">
                                <h1 class="mb-2">{{ $item->slider_text }}</h1>
                                <h2 class="subheading mb-4">{{ $item->slider_description }}</h2>
    ...
    <section class="ftco-section ftco-category ftco-no-pt">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 order-md-last align-items-stretch d-flex">
                            <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex"
                                style="background-image: url({{ url('frontend/images/category.jpg);') }}">
                        ...
                        <div class="col-md-6">
                            <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                                style="background-image: url({{ url('frontend/images/category-1.jpg') }});">
                                <div class="text px-3 py-1">
                                    <h2 class="mb-0"><a href="#">Fruits</a></h2>
                                </div>
                            </div>
                            <div class="category-wrap ftco-animate img d-flex align-items-end"
                                style="background-image: url({{ url('frontend/images/category-2.jpg') }});">
                                <div class="text px-3 py-1">
                ...
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end"
                        style="background-image: url({{ url('frontend/images/category-3.jpg') }});">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a href="#">Juices</a></h2>
                        </div>
                    </div>
                    <div class="category-wrap ftco-animate img d-flex align-items-end"
                        style="background-image: url({{ url('frontend/images/category-4.jpg') }});">
                        <div class="text px-3 py-1">
                ...
                @foreach ($productsData as $key => $item)
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <a href="#" class="img-prod"><img class="img-fluid" src="{{ asset($item->product_img) }}"
                                    alt="Colorlib Template">
                                <span class="status">{{ $item->is_available }}</span>
                                <div class="overlay"></div>
                            </a>
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span
                                                class="mr-2 price-dc">$120.00{{ $item->purchasing_price }}</span><span
                                                class="price-sale">{{ $item->selling_price }}</span></p>
                                    </div>
                                </div>
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        <a href="{{ route('addToCart', ['id' => $item->id]) }}" class="add-to-cart d-flex justify-content-center align-items-center text-center">
                                            <span><i class="ion-ios-menu"></i></span>
                                        </a>
                                        <a href="javascript:void(0)" onclick="add_to_cart(`{{$item->id}}`,`{{$item->selling_price}}`,`1`)"
    ...
    <section class="ftco-section img" style="background-image: url({{ url('frontend/images/bg_3.jpg') }});">
        <div class="container">
    ...
    <script>
        function add_to_cart(productId,price,quantity){
